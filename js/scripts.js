document.addEventListener('DOMContentLoaded', () => {
  ...
  const projects = [
    ...
    { title: 'Bank', desc: 'Sistema de gestión bancaria completo para administrar transacciones y cuentas', cat: 'Apps', icon: 'fas fa-university', logo: 'Image/portafolio/bank/logo.png', preview: 'Image/portafolio/bank/portada.jpg', link: '', images: ['Image/portafolio/bank/img.png'] },
    { title: 'Ecommer-Z', desc: 'Plataforma de e-commerce inteligente para vender productos online', cat: 'Apps', icon: 'fas fa-shopping-cart', logo: 'Image/portafolio/ecommer_z/logo.png', preview: 'Image/portafolio/ecommer_z/portada.jpg', link: '', images: ['Image/portafolio/ecommer_z/img.jpeg'] },
